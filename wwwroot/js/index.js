...
(function carouselSlide() {
    // 图片信息
    const imgData = [
        { url: '../imgs/Index/carousel-slide0.jpg', title: '111', color: 'rgba(100,67,68,0.9)', source: 'https://www.pixiv.net/artwork/' },
        { url: '../imgs/Index/carousel-slide1.jpg', title: '222', color: 'rgba(102,67,68,0.9)', source: 'https://www.pixiv.net/artwork/' },
        { url: '../imgs/Index/carousel-slide2.jpg', title: '333', color: 'rgba(100,57,56,0.9)', source: 'https://www.pixiv.net/artwork/' },
        { url: '../imgs/Index/carousel-slide3.jpg', title: '444', color: 'rgba(100,67,74,0.9)', source: 'https://www.pixiv.net/artwork/' },
        { url: '../imgs/Index/carousel-slide4.jpg', title: '555', color: 'rgba(100,42,68,0.9)', source: 'https://www.pixiv.net/artwork/' },
        { url: '../imgs/Index/carousel-slide5.jpg', title: '666', color: 'rgba(190,67,68,0.9)', source: 'https://www.pixiv.net/artwork/' },
        { url: '../imgs/Index/carousel-slide6.jpg', title: '777', color: 'rgba(100,21,68,0.9)', source: 'https://www.pixiv.net/artwork/' }
    ]
